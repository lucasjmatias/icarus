...
# To build 'icarus', we depend on the object files, and link them all into a single executable using the compilation tool
# We use automatic variables to specify the final executable name 'icarus', using '$@' and the '$^' will hold the names of all the
